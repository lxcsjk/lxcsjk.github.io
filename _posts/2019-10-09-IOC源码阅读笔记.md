...
- FileSystemResource ：对 java.io.File 类型资源的封装，只要是跟 File 打交道的，基本上与 FileSystemResource 也可以打交道。支持文件和 URL 的形式，实现 WritableResource 接口，且从 Spring Framework dd5.0 开始，FileSystemResource 使用 NIO2 API进行读/写交互。
...
**![整体流程](http://static.iocoder.cn/38419d23d29c83a4758f73f85281e076)**
